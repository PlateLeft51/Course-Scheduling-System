<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InfoAud.aspx.cs" Inherits="实验室排课系统.Admin.InfoAud" %>
    ...
    <form id="form1" runat="server">
        <div class="sidebar">
            ...
            <ol>
                ...
                <li class="sidebar-auditor-selected"><a href="InfoAud.aspx" class="refer">审核员管理</a></li>
        ...
        <div class="domin">
            <div class="theme">
                <div class="theme-content"><h1>审核员管理</h1></div>
            </div>
