<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info.aspx.cs" Inherits="实验室排课系统.Student.Info" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="domin">
            ...
            <div class="content">
                ...
                <div class="info-value">174906</div>
                <div class="info-key">姓名</div>
                <div class="info-value" id="name">陈明</div>
                <div class="info-key">密码</div>
                <div class="info-value">******</div>
                <div class="info-key">性别</div>
                <div class="info-value">男</div>
                <div class="info-key">身份证号</div>
                <div class="info-value">130102199903072973</div>
                <div class="info-key">班级</div>
                <div class="info-value">计172</div>
                ...
                <div class="info-value">计172班数据结构课代表</div>
