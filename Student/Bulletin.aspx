<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bulletin.aspx.cs" Inherits="实验室排课系统.Student.Bulletin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="domin">
            ...
            <div class="content">
                ...
                <!-- <asp:Button runat="server" class="button-view tea-bulletin-pos1" onclick="download" text="发布公告" ></asp:Button> -->
                <div class="chart">
    ...
    <div class="win-background" id='win-background'>
            ...
            <div class="win-notice-pos2 info-key">陈芳华</div>
            <div class="win-notice-pos3 info-key">2021/04/07 12:43</div>
            <div class="win-notice-pos4">各位同学：<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;根据实验室安排，数据结构课程现安排于第8周周二第三大节在实验室106进行，请大家及时调整时间准时上课。</div>
